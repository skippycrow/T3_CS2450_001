...
class EditEmployee(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.title_label = tk.Label(self, text="Edit Employee - Will be populated with employee info")
        ...
        # City
        self.edit_city_label = tk.Label(self, text="City:").grid(row=2, column=2, pady=5, sticky=tk.W)
        self.edit_city_entry = tk.Entry(self, width=15, bg="white").grid(row=2, column=3)

        # State
        self.edit_state_label = tk.Label(self, text="State:").grid(row=2, column=4, pady=5, sticky=tk.W)
        self.edit_state_entry = tk.Entry(self, width=15, bg="white").grid(row=2, column=5)

        # Zip
        self.edit_zip_label = tk.Label(self, text="Zip:").grid(row=3, column=0, pady=5, sticky=tk.W)
        self.edit_zip_entry = tk.Entry(self, width=15, bg="white").grid(row=3, column=1)

        # Phone
        self.edit_phone_label = tk.Label(self, text="Phone:").grid(row=3, column=2, pady=5, sticky=tk.W)
        self.edit_phone_entry = tk.Entry(self, width=15, bg="white").grid(row=3, column=3)

        # Email
        self.edit_emp_id_label = tk.Label(self, text="Email:").grid(row=3, column=4, pady=5, sticky=tk.W)
        self.edit_emp_id_entry = tk.Entry(self, width=15, bg="white")
        self.edit_emp_id_entry.grid(row=3, column=5)
        ...
        self.edit_permission_entry = tk.Entry(self, width=15, bg="white")
